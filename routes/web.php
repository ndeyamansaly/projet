...
Route::get('/candidats_par_formation', [DashboardController::class, 'candidaturesParFormation'])->name('c-p-f');
Route::get('/formations_par_referentiel', [DashboardController::class, 'formationsParReferentiel'])->name('f-p-r');
Route::get('/candidats_par_sexe', [DashboardController::class, 'candidaturesParSexe'])->name('c-p-s');
Route::get('/formations_par_type', [DashboardController::class, 'formationsParType'])->name('f-p-t');
Route::get('/tranches-age', [DashboardController::class, 'trancheAge'])->name('t-a');
Route::get('/formations_par_statut', [DashboardController::class, 'formationsParStatut'])->name('f-p-s');
